...
// uart_tx.v
//
// Transmits 8-bit data frames over a serial line. 
// Configured via parameters for baud rate division and parity.
// ==================================================================================
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            case (state)
                ...
                S_START: begin
                    tx <= 1'b0; // Drive line low for Start Bit
                ...
                S_DATA: begin
                    tx <= tx_shift[bit_idx]; // Shift out LSB first
                    if (baud_cnt == CLKS_PER_BIT - 1) begin
                        baud_cnt <= 0;
                        if (bit_idx == 7) begin
                            bit_idx <= 0;
